										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														<c:if test="${linkman.lkmGender==1 }">男</c:if>
														<c:if test="${linkman.lkmGender==2 }">女</c:if>
													</TD>
													<TD>${linkman.lkmPhone }</TD>
													<TD>${linkman.lkmMobile }</TD>
													
													<TD>
													<a href="${pageContext.request.contextPath }/linkman_toupdate?lkmId=${linkman.lkmId}">修改</a>
													&nbsp;&nbsp;
