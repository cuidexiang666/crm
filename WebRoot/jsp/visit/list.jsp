...
<SCRIPT language=javascript>
	function to_page(page){  //page 1 2 3 0
		if(page){   //如果page>0  if(page)返回true  如果page<=0  if(page)返回false
			$("#page").val(page);
		}
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>客户名称：</TD>
													<TD><INPUT class=textbox id=sChannel2 
														style="WIDTH: 80px" maxLength=50 name="customer.custName"></TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												<!-- 判断当前页是否是第1页，如果不是第一页 “前一页”显示 -->
												<c:if test="${pageBean.currentPage!=1}">
												  [<A  href="#" onclick="to_page(${pageBean.currentPage-1})"">前一页</A>]
												</c:if>
												
												<!-- 判断当前页是否和总页数相等，如果不相等显示“后一页” -->
												<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
												[<A href="javascript:to_page(${pageBean.currentPage+1})">后一页</A>] 
												</c:if>
												<input type="hidden" value="0" id="page" name="currentPage" />
