...
// top.location    http://localhost:8080/crm_253/
// self.location   http://localhost:8080/crm_253/visitAction_toadd.action
if(top.location!=self.location){
	top.location = "${pageContext.request.contextPath}/login.jsp";
}
</script>
<BODY>
<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" action="${pageContext.request.contextPath }/user_login.action" method=post>
        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              </TD><TD><a href="${pageContext.request.contextPath }/user_toregister.action">注册</a></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
